...
from localshool_management.users.models import User
from localshool_management.users.tests.factories import UserFactory
from localshool_management.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
