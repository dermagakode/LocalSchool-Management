...
if READ_DOT_ENV_FILE:
    ...
    env.read_env(str(ROOT_DIR / ".envs/.local/.secret"))
...
LOCAL_APPS = [
    "localshool_management.users.apps.UsersConfig",
...
MIGRATION_MODULES = {"sites": "localshool_management.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "localshool_management.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Tegar Imansyah""", "egar.imansyah@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "localshool_management.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "localshool_management.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
